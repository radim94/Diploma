function [ Fcoarseness,Fcontrast,Fdirection ] = TamuraM( IColor )
...
%IColor = imread('C:\Users\User\Desktop\Наука\Science now-now\Science_now\Science\180912\melan\3ddd.tif',20);
%I=im2double(IColor);
